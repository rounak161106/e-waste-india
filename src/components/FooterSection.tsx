    ...
    <div className="max-w-6xl mx-auto grid sm:grid-cols-3 gap-10 mb-12">
      <div>
        ...
        <div className="flex gap-4 mt-4">
          <a href="https://www.instagram.com/explore/tags/ewasteindia/" target="_blank" rel="noopener noreferrer" aria-label="Instagram — #EWasteIndia" className="text-ewaste-muted/50 hover:text-ewaste-green transition-colors">
          ...
          <a href="https://wa.me/?text=Check%20out%20this%20e-waste%20awareness%20project%20by%20LPU%20students%3A%20https%3A%2F%2Frounak161106.github.io%2Fe-waste-india%2F" target="_blank" rel="noopener noreferrer" aria-label="Share on WhatsApp" className="text-ewaste-muted/50 hover:text-ewaste-green transition-colors">
          ...
          <a href="https://github.com/rounak161106/e-waste-india" target="_blank" rel="noopener noreferrer" aria-label="GitHub Repository" className="text-ewaste-muted/50 hover:text-ewaste-green transition-colors">
