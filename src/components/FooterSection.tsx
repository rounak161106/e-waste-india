    ...
    <div className="max-w-6xl mx-auto grid sm:grid-cols-3 gap-10 mb-12">
      <div>
        ...
        <div className="flex gap-4 mt-4">
          ...
          <a href="https://www.linkedin.com/in/rounakprasad" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="text-ewaste-muted/50 hover:text-ewaste-green transition-colors">
